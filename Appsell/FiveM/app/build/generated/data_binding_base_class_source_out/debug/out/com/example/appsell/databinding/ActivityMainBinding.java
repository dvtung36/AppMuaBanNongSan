...
public final class ActivityMainBinding implements ViewBinding {
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      FragmentContainerView navHostFragmentContentMain = rootView.findViewById(id);
      if (navHostFragmentContentMain == null) {
        break missingId;
      }

      return new ActivityMainBinding((ConstraintLayout) rootView, navHostFragmentContentMain);
    }
