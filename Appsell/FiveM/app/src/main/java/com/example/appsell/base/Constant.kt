...
class Constant {
    companion object {
        ...
        const val PRODUCT_HA: String = "ha"
        const val PRODUCT_DOKHO : String = "dokho"
        const val PRODUCT_DONGLANH : String = "donglanh"
        const val PRODUCT_TRAICAY : String = "traicay"
        const val PRODUCT_NUOCNGOT : String = "nuocngot"
